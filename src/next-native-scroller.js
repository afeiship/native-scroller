(function () {
  ...
  var NativeScroller = nx.declare('nx.NativeScroller', {
    methods: {
      ...
      destroy: function () {
        if (scrollChild) {
          Event.off(touchStartEvent, handleTouchstart, scrollChild);
          Event.off(touchMoveEvent, handleTouchmove, scrollChild);
          Event.off(touchEndEvent, handleTouchend, scrollChild);
          Event.off('mousedown', handleMousedown, scrollChild);
          Event.off('mousemove', handleTouchmove, scrollChild);
          Event.off('mouseup', handleTouchend, scrollChild);
        }
        if (scrollParent) {
          Event.off('scroll', handleScroll, scrollParent);
        }
        scrollParent = null;
        scrollChild = null;
      },
